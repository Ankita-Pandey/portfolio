<div class="__variable_20b187 group/spotlight relative">
	<div
		...
		style="background: radial-gradient(600px at 823px 5px, rgba(29, 78, 216, 0.15), transparent 80%);"
	/>
	<div
				...
				<ul class="ml-1 mt-8 flex items-center" aria-label="Social media">
					<li class="mr-5 text-xs shrink-0">
						<a
							...
							href="https://github.com/Ankita-Pandey"
							target="_blank"
							rel="noreferrer noopener"
					...
					<li class="mr-5 text-xs shrink-0">
						<a
							class="block hover:text-slate-200"
							href="https://www.linkedin.com/in/ankita-pandey-721264188/"
							target="_blank"
							rel="noreferrer noopener"
					...
					<li class="mr-5 text-xs shrink-0">
						<a
							class="block hover:text-slate-200"
							href="https://twitter.com/AnkitaPand49625"
							target="_blank"
							rel="noreferrer noopener"
					...
					<li class="mr-5 text-xs shrink-0">
						<a
							class="block hover:text-slate-200"
							href="mailto:ankitapandey@vt.edu"
							aria-label="Email"
							title="Email"
						>
				...
				>
					...
					<div>
						<p class="mb-4 text-justify">
							My educational journey, with a Master's in Data Science and a Bachelor's in Computer
							Science, underpins my expertise. My career spans diverse roles where I've developed
							proficiency in Python, data analysis, and machine learning algorithms. I'm passionate
							about using data-driven insights for impactful business decisions and crafting machine
							learning models that solve real-world challenges. Constantly seeking to grow and apply
							my skills, I aim to innovate and make a meaningful impact in the field of data
							science.
						</p>
						<p class="mb-4 text-justify">
							My practical experience in deploying machine learning models in production
							environments has enabled me to understand the nuances of real-time data processing and
							decision-making. I am adept at working with large datasets and complex algorithms,
							always aiming to turn data into actionable insights. My approach combines technical
							skills with a keen understanding of business contexts, ensuring that my contributions
							are not just technically sound, but also strategically aligned with organizational
							goals. I am committed to staying at the forefront of technological advancements in
							data science, continually expanding my skills and knowledge to remain a valuable asset
						...
						<ol class="group/list">
							<li class="mb-12">
								...
								>
									...
									<header
										...
										aria-label="August 2021 to July 2023"
									>
										Aug 2021 — Jul 2023
									</header>
									<div class="z-10 sm:col-span-6">
										<h3 class="font-medium leading-snug text-slate-200">
											<div>
												<a
													...
													target="_blank"
													rel="noreferrer noopener"
													aria-label="Graduate Data Analyst - ETL Developer at Barclays(opens in a new tab)"
													><span
														class="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"
													/><span
														>Graduate Data Analyst - ETL Developer ·<!-- -->
										...
										<p class="mt-2 text-sm leading-normal text-justify">
											• Innovatively developed an analytics tool using Tableau to validate the
											authenticity of internal business data against the source data, providing
											actionable insights to business stakeholders. <br />• Spearheaded the
											development of a data pipeline for the NGCB project, significantly reducing
											the customer records comparison processing time by 85%, from 120s to 18s.<br
											/>• Demonstrated leadership by supervising two developers, creating a
											data-retrieving website, and establishing a CICD pipeline with Jenkins, JUnits
											testing, and Hadoop integration.
										</p>
							...
							<li class="mb-12">
								...
								>
									...
									<header
										class="z-10 mb-2 mt-1 text-xs font-semibold uppercase tracking-wide text-slate-500 sm:col-span-2"
										aria-label="June 2020 to August 2020"
									>
										Jun 2020 — Aug 2020
									</header>
									<div class="z-10 sm:col-span-6">
										...
										<p class="mt-2 text-sm leading-normal text-justify">
											• Pioneered the development of a highly sophisticated mobile forensic
											application that achieveda 98.5% data cleansing accuracy.<br />• Conducted
											in-depth exploratory data analysis (EDA), revealing complex attack patterns
											and deploying advanced Artificial Neural Networks (ANN) to predict and prevent
											fraudulent activities with a remarkable 99.02% accuracy rate.
										</p>
										<!-- <ul class="mt-2 flex flex-wrap" aria-label="Related links">
											<li class="mr-4">
												<a
							...
							<li class="mb-12">
								...
								>
									...
									<header
										class="z-10 mb-2 mt-1 text-xs font-semibold uppercase tracking-wide text-slate-500 sm:col-span-2"
										aria-label="June 2019 to August 2020"
									>
										Jun 2019 — Aug 2020
									</header>
									<div class="z-10 sm:col-span-6">
										...
										<p class="mt-2 text-sm leading-normal text-justify">
											• Conceptualized and executed a cost-effective and scalable private cloud
											storage solution using Raspberry Pi hardware, outperforming traditional
											alternatives.<br />• Led a project team in designing a system capable of
											storing and processing upto 1 terabyte of data.
										</p>
										<!-- <ul class="mt-2 flex flex-wrap" aria-label="Related links">
											<li class="mr-4">
												<a
								...
								>
									...
									<div class="z-10 sm:order-2 sm:col-span-6">
										...
										<p class="mt-2 text-sm leading-normal">
											Developed a mobile app for NGO's waste management, improving sorting
											efficiency by 50% and reducing costs by 30% using machine learning-driven EDA
							...
							<li class="mb-12">
								...
								>
									...
									<div class="z-10 sm:order-2 sm:col-span-6">
										...
										<p class="mt-2 text-sm leading-normal">
											Developed a smart vehicle with 95% accuracy in motion analysis, 97% accuracy
											in image recognition, and precise obstacle detection. Successfully conducted
											real-road tests for traffic signal navigation, pedestrian detection, and
											drowsy driver identification.
										</p>
									</div>
									<!-- <img
										alt="Build a Spotify Connected App Newline course marketing card"
									...
									<div class="z-10 sm:order-2 sm:col-span-6">
										<h3>
											<a
												...
												/>Yoga App | <!-- -->
												<span class="inline-block ml-2">
													Python, Node JS, OpenPose, Flutter
													<!-- <svg
															xmlns="http://www.w3.org/2000/svg"
															viewBox="0 0 20 20"
															fill="currentColor"
										...
										<p class="mt-2 text-sm leading-normal">
											Founded and directed a holistic yoga promotion startup,achieving a 98%
											accuracy rate in yoga posture recognition and correction using cutting-edge
				...
				<footer class="max-w-md pb-16 text-sm text-slate-500 sm:pb-0">
					<p>
						...
						<a
							...
							target="_blank"
							rel="noreferrer noopener"
							aria-label="Brittany Chiang(opens in a new tab)">Brittany Chiang</a
						>. Built with<!-- -->
						<a
