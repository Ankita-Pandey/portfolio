		...
		<div class="lg:flex lg:justify-between lg:gap-4">
				...
				<ul class="ml-1 mt-8 flex items-center" aria-label="Social media">
					...
					<li class="mr-5 text-xs shrink-0">
						<a
							...
							title="Goodreads"
							><span class="sr-only">Goodreads</span><svg
								xmlns="http://www.w3.org/2000/svg"
				...
				>
					...
					<div>
						...
						<p class="mb-4">
							...
							— things that look good but are also built well under the hood. In my free time, I've
							also released an<!-- -->
							<a
								class="font-medium text-slate-200 hover:text-teal-300 focus-visible:text-teal-300"
								...
								>
									...
									<div class="z-10 sm:col-span-6">
										...
										<p class="mt-2 text-sm leading-normal">
											...
											within engineering department through close collaboration, knowledge shares,
								...
								>
									...
									<div class="z-10 sm:order-2 sm:col-span-6">
										...
										<a
											...
											target="_blank"
											rel="noreferrer noopener"
											aria-label="596 stars on GitHub (opens in a new tab)"
											><svg
												xmlns="http://www.w3.org/2000/svg"
												viewBox="0 0 20 20"
												fill="currentColor"
								...
								>
									...
									<div class="z-10 sm:order-2 sm:col-span-6">
										...
										<a
											...
											target="_blank"
											rel="noreferrer noopener"
											aria-label="6942 stars on GitHub (opens in a new tab)"
											><svg
												xmlns="http://www.w3.org/2000/svg"
												viewBox="0 0 20 20"
												fill="currentColor"
			...
			<div>
				<button
					...
					data-state="closed"
					><span class="sr-only">Click to time travel</span><img
